...
Begin VB.Form FormDifficultyIndexHelp 
   ...
   MaxButton       =   0   'False
   MinButton       =   0   'False
   MouseIcon       =   "FormDifficultyIndexHelp.frx":23D2
   ...
   Begin VB.TextBox TextboxWelcome 
      ...
      Left            =   315
      Locked          =   -1  'True
      MouseIcon       =   "FormDifficultyIndexHelp.frx":2524
      MousePointer    =   99  'Custom
      MultiLine       =   -1  'True
      TabIndex        =   2
      Text            =   "FormDifficultyIndexHelp.frx":2676
      Top             =   1155
      Width           =   17340
   End
   ...
   Begin VB.Label LabelDifficultyIndexTitle 
      ...
      Caption         =   "INFORMATION  OF  THE  CALCULATION  OF  DIFFICULTY  INDEX"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   24
         Charset         =   0
